...
solved_package_exceptions = exceptions.labels(message_type="solved_package")
solved_package_sent_advise_requests = sent_advise_requests.labels(message_type="solved_package")
